...
const QString BITCOIN_IPC_PREFIX("kfcoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click kfcoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start kfcoin: click-to-pay handler");
    else
...
{
    // clicking on kfcoin: URLs creates FileOpen events on the Mac:
